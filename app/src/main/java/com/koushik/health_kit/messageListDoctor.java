...
public class messageListDoctor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(this,
            ...
            public void onClick(View view, final int position) {
                ...
                i.putExtra("doctorname",title2);
                i.putExtra("doctoruid",title1);
                i.putExtra("flag",1);
                startActivity(i);
    ...
    private void addToList()
    {
        ...
        dbDoctor.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                {
                    patientuid = (String) ds.getKey();
                    Toast.makeText(getApplicationContext(),patientuid,Toast.LENGTH_SHORT).show();
                    seeInPatient();
                }
            }
    ...
    private void seeInPatient(){
        dbPatient.child(patientuid).addListenerForSingleValueEvent(valueEventListener);
    }
